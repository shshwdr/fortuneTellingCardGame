...
namespace Naninovel
{
    ...
    public class ScriptsConfiguration : Configuration
    {
        ...
        [Tooltip("Directory path relative to the Unity project root, where all the scenario script assets (.nani files) are stored.")]
        public string ScenarioRoot = "Assets/Scenario";
        ...
        [Tooltip("Whether to run a file system watcher over '.nani' files in the specified 'Scenario Root'. Required to register script changes when edited with an external application.")]
